    ...
    return (
        <div className="about">
            <div className="row row-1">
                ...
                <div className="right">
                    <h2>I’m Sean, an interface designer and developer. I graduated from Georgia Tech with a B.S. in Computer Science.</h2>
                        ...
                        <div className="section-info">
                            <div className="section-info--item">
                                ...
                                <div className="section-info--item--content">
                                    <p className="first-p--0">My passion for design started when I was 8 years old.</p>
                                    ...
                                    <p>I befriended amateur graphic designers through niche MSN Messenger circles who taught me how to bootleg Adobe Photoshop CS2. By age 10, I ended up running prolific siggy shops of my own.</p>
                                </div>
                            </div>
                        </div>
                        <div className="section-info">
                            <div className="section-info--item">
                                <h3>Fun fact</h3>
                                <div className="section-info--item--content">
                                    <p className="first-p--0">In another world, I would probably be working at a chemical plant or doing research on renewable energy. I completed 3 years of a chemical engineering degree before discovering human-computer interaction and UX design. These fields fuse my love for visual beauty, science, and complex systems.</p>
                                </div>
                            </div>
                        </div>
                        <div className="section-info">
